            ...
            <div className="  bg-base-200  " >
                <div className="   grid grid-flow-row lg:grid-cols-2  "  style={{ justifyItems: 'center' }}>
                    ...
                    <div className=" min-[320px]:text-center lg:text-start " data-aos="zoom-out-right" data-aos-duration="2000" >
                        ...
                        <div className="   "  >
                            <div className="  grid grid-flow-col gap-6 text-emerald-500 my-10  ">
                                ...
                                <a href="https://twitter.com/ObaydulKuasha" target="_blank" rel="noopener noreferrer" className="  me-auto  border-2 border-emerald-400 rounded-full text-3xl   ">  <FaTwitter /> </a>
                                <a href="https://www.instagram.com/obaydul_kuasha/" target="_blank" rel="noopener noreferrer" className="  me-auto  border-2 border-emerald-400 rounded-full text-3xl  ">  <FaInstagram /> </a>
                                <a href="https://www.linkedin.com/in/obaydulkuasha/" target="_blank" rel="noopener noreferrer" className="  me-auto  border-2 border-emerald-400 rounded-full text-3xl ">  <FaLinkedin /> </a>
