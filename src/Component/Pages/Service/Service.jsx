        ...
        <div className="  ">
            <div>
                <div className="py-10 ">
                    ...
                    <div className="lg:grid grid-flow-row grid-cols-3 gap-6  bg-opacity-50 rounded-2xl    ">
                        <div className='bg-white bg-opacity-50 rounded-tr-2xl rounded-bl-2xl shadow-2xl p-4 grid lg:grid-flow-col lg:gap-5  lg:items-center text-center  '>
